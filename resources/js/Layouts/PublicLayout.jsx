...
export const NAV_LINKS = [
    { get label() { return i18n.t('Fitur'); }, href: "/fitur" },
    { get label() { return i18n.t('Dokumentasi'); }, href: "/dokumentasi" },
    { get label() { return i18n.t('Roadmap'); }, href: "/roadmap" },
    { get label() { return i18n.t('Kontribusi'); }, href: "/kontribusi" },
];
