    ...
    return (
        ...
        >
            ...
            <div className="text-center mb-2">
                ...
                {storePhone && <p className="text-xs">{t('Telp: {{0}}', { 0: storePhone })}</p>}
                {storeEmail && <p className="text-xs">{t('Email: {{0}}', { 0: storeEmail })}</p>}
                            ...
                            {Number(item.discount_total || 0) > 0 &&
                                baseUnitPrice > unitPrice && (
                                    <div className="flex justify-between text-[10px] text-slate-500">
                                        <span>
                                            {t('Promo: {{0}}', { 0: item.pricing_group_label ||
            ...
            <div className="my-1">
                ...
                {Number(transaction?.tax_total || 0) > 0 && (
                    <div className="flex justify-between">
                        <span>{t('PPN {{0}}%', { 0: Number(transaction?.tax_rate || 11).toFixed(0) })}</span>
            ...
            <div className="my-1">
                <div className="flex justify-between">
                    <span>{t('Bayar ({{0}})', { 0: paymentMethod })}</span>
