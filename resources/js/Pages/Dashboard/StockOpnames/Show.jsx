                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            {t('Dibuat oleh {{0}} • {{1}}', { 0: stockOpname.creator?.name || "-", 1: formatDateTime(stockOpname.created_at) })}
                        </p>
                        {!isDraft && (
                            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                {t('Difinalisasi oleh {{0}} • {{1}}', { 0: stockOpname.finalizer?.name || "-", 1: formatDateTime(stockOpname.finalized_at) })}
                            </p>
                        )}
                    </div>
                                ...
                                {availableProducts.map((product) => (
                                    ...
                                    >
                                        <div>
                                            ...
                                            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                                                {t('Stok sistem: {{0}}', { 0: product.stock })}
                                            </p>
                                        </div>
