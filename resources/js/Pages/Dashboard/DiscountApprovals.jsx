                            ...
                            <div key={tx.id} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500 dark:text-slate-400">{t('Kasir:')} {tx.cashier}</p>
                                        <p className="text-sm text-slate-500 dark:text-slate-400">{t('Pelanggan:')} {tx.customer}</p>
                                    </div>
