...
const targetOptions = [
    { value: "all", get label() { return i18next.t('Semua Produk'); } },
    { value: "product", get label() { return i18next.t('Produk Tertentu'); } },
    { value: "category", get label() { return i18next.t('Kategori Tertentu'); } },
];

const customerScopeOptions = [
    { value: "all", get label() { return i18next.t('Semua Pelanggan'); } },
    { value: "walk_in", get label() { return i18next.t('Tanpa Pelanggan / Umum'); } },
    { value: "registered", get label() { return i18next.t('Pelanggan Terdaftar'); } },
    { value: "member", get label() { return i18next.t('Member Loyalty'); } },
];

const discountTypeOptions = [
    { value: "percentage", get label() { return i18next.t('Persentase (%)'); } },
    { value: "fixed_amount", get label() { return i18next.t('Potongan Nominal'); } },
    { value: "fixed_price", get label() { return i18next.t('Harga Final'); } },
];
