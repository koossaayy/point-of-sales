                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            {t('{{0}} hak akses', { 0: role.permissions.length })}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-wrap gap-1.5 max-h-24 overflow-y-auto scrollbar-thin">
                    ...
                    {role.permissions.length > 8 && (
                        <span className="px-2 py-0.5 text-xs font-medium text-slate-500">
                            {t('+{{0}} lainnya', { 0: role.permissions.length - 8 })}
                        </span>
                    )}
                </div>
            </div>
        ...
        <>
            ...
            <div className="mb-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            {t('{{0}} group terdaftar', { 0: roles.total || roles.data?.length || 0 })}
                        </p>
                    </div>
                    {canCreateRoles && (
                        <Button
            ...
            <div className="mb-4 w-full sm:w-80">
                <Search
                    ...
                    placeholder={t('Cari akses group...')}
                />
            </div>
            ...
            <Modal
                ...
                title={
                    data.isUpdate ? t('Ubah Akses Group') : t('Tambah Akses Group')
                }
                ...
                <form onSubmit={data.isUpdate ? updateRole : saveRole}>
                    <div className="mb-4">
                        <Input
                            label={t('Nama group')}
                            type={"text"}
                            placeholder={t('Masukan nama group')}
                            value={data.name}
            ...
            {roles.data.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                        {t('Tambahkan group akses pertama.')}
                    </p>
                    <Button
                        type={"button"}
