...
const errorContent = {
    401: {
        get title() { return i18next.t('Autentikasi Dibutuhkan'); },
        get description() { return i18next.t('Sesi atau akses Anda tidak valid. Silakan masuk kembali untuk melanjutkan.'); },
        icon: IconLock,
    },
    403: {
        get title() { return i18next.t('Akses Ditolak'); },
        get description() { return i18next.t('Anda tidak memiliki izin untuk membuka halaman ini.'); },
        icon: IconLock,
    },
    404: {
        get title() { return i18next.t('Halaman Tidak Ditemukan'); },
        get description() { return i18next.t('Halaman yang Anda cari tidak tersedia, dipindahkan, atau URL yang dimasukkan tidak tepat.'); },
        icon: IconAlertTriangle,
    },
    419: {
        get title() { return i18next.t('Sesi Kedaluwarsa'); },
        get description() { return i18next.t('Sesi keamanan telah berakhir. Muat ulang halaman lalu coba kembali.'); },
        icon: IconRefresh,
    },
    429: {
        get title() { return i18next.t('Terlalu Banyak Permintaan'); },
        get description() { return i18next.t('Permintaan Anda dibatasi sementara. Tunggu sebentar sebelum mencoba lagi.'); },
        icon: IconAlertTriangle,
    },
    500: {
        get title() { return i18next.t('Terjadi Kesalahan Server'); },
        get description() { return i18next.t('Ada gangguan pada sistem. Silakan coba lagi dalam beberapa saat.'); },
        icon: IconServerOff,
    },
    503: {
        get title() { return i18next.t('Layanan Sementara Tidak Tersedia'); },
        get description() { return i18next.t('Aplikasi sedang dalam pemeliharaan atau belum siap melayani permintaan ini.'); },
        icon: IconServerOff,
    },
};
