...
const stats = [
    { value: "200+", get label() { return i18n.t('GitHub Stars'); } },
    { value: "44+", get label() { return i18n.t('Fitur Lengkap'); } },
    { value: "MIT", get label() { return i18n.t('100% Gratis'); } },
    { value: "8", get label() { return i18n.t('Modul Terintegrasi'); } },
];

const features = [
    {
        icon: IconShoppingCart,
        get title() { return i18n.t('POS Cepat & Mudah'); },
        get desc() { return i18n.t('Cari produk via barcode atau keyboard, scan pakai kamera (PWA), cart hold/resume, dan checkout dalam hitungan detik.'); },
    },
    {
        icon: IconWallet,
        title: "Multi-Payment",
        get desc() { return i18n.t('Tunai, transfer bank, QRIS (Midtrans), Xendit, hingga pay later (piutang) — semua dalam satu kasir.'); },
    },
    {
        icon: IconBuildingWarehouse,
        title: "Multi-Warehouse",
        get desc() { return i18n.t('Stok terpisah per gudang/cabang, transfer antar gudang, stock opname, dan tracking batch/expiry (FEFO).'); },
    },
    {
        icon: IconReceiptTax,
        get title() { return i18n.t('PPN & Pajak'); },
        get desc() { return i18n.t('Dukungan PPN 11% (exclusive/inclusive), data NPWP pelanggan, dan laporan pajak yang rapi.'); },
    },
    {
        icon: IconChartBar,
        get title() { return i18n.t('Laporan & Insight'); },
        get desc() { return i18n.t('Laporan penjualan, profit & margin, performa per kasir, jam sibuk, dan repeat customer.'); },
    },
    {
        icon: IconReportMoney,
        get title() { return i18n.t('Piutang & Hutang'); },
        get desc() { return i18n.t('Kelola piutang pelanggan & hutang supplier dengan aging analysis dan partial payment.'); },
    },
    {
        icon: IconUsers,
        get title() { return i18n.t('CRM & Loyalty'); },
        get desc() { return i18n.t('Member tiers, poin loyalty, voucher, segmentasi pelanggan otomatis, dan campaign marketing.'); },
    },
    {
        icon: IconBrandWhatsapp,
        get title() { return i18n.t('WhatsApp Gateway'); },
        get desc() { return i18n.t('Kirim struk, reminder piutang, dan promo otomatis ke pelanggan via WhatsApp (whatsapp-web.js).'); },
    },
    {
        icon: IconShieldLock,
        get title() { return i18n.t('RBAC & Audit Log'); },
        get desc() { return i18n.t('Kontrol akses per role (admin/kasir), persetujuan diskon, dan jejak audit before/after setiap perubahan.'); },
    },
    {
        icon: IconCloudOff,
        get title() { return i18n.t('Offline Mode'); },
        get desc() { return i18n.t('Tetap bisa jualan saat internet mati — transaksi masuk antrean dan tersinkron otomatis saat online.'); },
    },
];
...
const screenshots = [
    { src: "/screenshots/01-dashboard.png", get title() { return i18n.t('Dashboard'); }, span: "col-span-2 row-span-2" },
    { src: "/screenshots/02-pos-checkout.png", get title() { return i18n.t('POS Checkout'); } },
    { src: "/screenshots/06-stock-opnames.png", get title() { return i18n.t('Stock Opname'); } },
    { src: "/screenshots/12-receivables.png", get title() { return i18n.t('Receivables'); } },
    { src: "/screenshots/15-sales-report.png", get title() { return i18n.t('Sales Report'); } },
];

const faqs = [
    {
        get q() { return i18n.t('Apakah Dikasir benar-benar gratis?'); },
        get a() { return i18n.t('Ya. Dikasir dirilis di bawah lisensi MIT — bebas digunakan, dimodifikasi, dan didistribusikan, termasuk untuk kepentingan komersial. Tidak ada biaya lisensi atau langganan.'); },
    },
    {
        get q() { return i18n.t('Bisakah dipakai untuk bisnis multi-cabang?'); },
        get a() { return i18n.t('Bisa. Dikasir mendukung multi-warehouse dengan stok terpisah per gudang/cabang, transfer stok antar gudang, dan laporan per gudang.'); },
    },
    {
        get q() { return i18n.t('Bagaimana kalau internet di toko mati?'); },
        get a() { return i18n.t('Dikasir punya offline mode: transaksi tetap bisa diproses dan masuk antrean lokal, lalu tersinkron otomatis saat koneksi kembali.'); },
    },
    {
        get q() { return i18n.t('Apa saja yang dibutuhkan untuk instalasi?'); },
        get a() { return i18n.t('PHP 8.3+, MySQL, Composer, dan Node.js 20+. Semua panduan lengkap ada di dokumentasi getting-started.'); },
    },
    {
        get q() { return i18n.t('Bagaimana cara berkontribusi?'); },
        get a() { return i18n.t('Fork repository, buat branch dari development (feature/nama-fitur), lalu buat Pull Request ke development. Pastikan php artisan test lulus sebelum submit.'); },
    },
];
